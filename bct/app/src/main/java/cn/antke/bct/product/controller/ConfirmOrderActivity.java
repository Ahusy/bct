...
import cn.antke.bct.person.controller.AddressListActivity;
import cn.antke.bct.person.controller.OrderListActivity;
import cn.antke.bct.product.adapter.OrderStoreAdapter;
import cn.antke.bct.product.adapter.OrderWayAdapter;
...
import static cn.antke.bct.R.id.ll_confirm_order_address;
...
//                        tvConfirmOrderAmount.setText(Html.fromHtml("合计:<font color=\"#ff3b3b\">"+InputUtil.formatPrice(productIntegral * multiple, productPrice)+"</font>"));
                        //总邮费计算
                        ...
                        tvConfirmOrderAmount.setText(Html.fromHtml("合计:<font color=\"#ff3b3b\">"+InputUtil.formatPrice(productIntegral * multiple+logisticsIntegral, productPrice+logisticsPrice)+"</font>"));
//                        tvConfirmOrderPostageAmount.setText(Html.fromHtml("运费:<font color=\"#ff3b3b\">"+InputUtil.formatLogistics(logisticsIntegral, logisticsPrice)+"</font>"));
                ...
                case CommonConstant.REQUEST_NET_TWO: {
                    ...
                    //如果有额度需要支付，先通过密码支付额度，如果没有则直接进入支付方式页面
