...
import cn.antke.bct.product.controller.NormsActivity;
...
public class CarProductAdapter extends BaseAdapterNew<ProductDetailEntity> {
    ...
    protected void setViewData(View convertView, int position) {
        ...
        if (productEntity != null) {
            ...
            tvCarProductDesc.setText(Html.fromHtml("单价:<font color=\"#ff3b3b\">" + "￥" + productEntity.getGoodsPrice() + "+" + productEntity.getGoodsIntegral() + "额度</font>"));
            String condition = "";
            ...
            if (activity != null && shopCarAdapter != null) {
                ...
                ivCarProductEdit.setOnClickListener(v -> {
                    NormsActivity.startNormsActivity(activity, CommonConstant.REQUEST_ACT_ONE, CommonConstant.FROM_SHOP_CAR_LIST, productEntity.getNormEntities(), parentPosition, position, productEntity.getGoodsId(),String.valueOf(productEntity.getCount()));
                });
            } else {
