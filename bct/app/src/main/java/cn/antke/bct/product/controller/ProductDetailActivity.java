...
public class ProductDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView ivProductDetailCar;
    ...
    private void initView() {
        ...
        tvCash.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
        ...
        if (CommonConstant.REQUEST_NET_SUCCESS.equals(result.getResultCode())) {
            switch (requestCode) {
                case CommonConstant.REQUEST_NET_ONE: {
                    ...
                    tvProductDetailPrice.setText(Html.fromHtml(InputUtil.formatPriceTwo(productDetail.getSellingIntegral(), productDetail.getSellingPrice())));
                    tvProductDetailPostage.setText("邮费：" + Html.fromHtml(InputUtil.formatLogistics(productDetail.getLogisticsIntegral(), productDetail.getLogisticsCost())));
                    ...
                    tvCash.setText("￥" + productDetail.getBuyingPrice());
                ...
                case CommonConstant.REQUEST_ACT_THREE: {
                    ...
                    if (datas != null && datas.size() != 0) {
                        ivProductDetailCar.setImageResource(R.drawable.car_02);
                    } else {
                        ivProductDetailCar.setImageResource(R.drawable.car_01);
                    }
                    break;
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_product_add_car:
                if (UserCenter.isLogin(this)) {
                    if (productDetail != null) {
                        NormsActivity.startNormsActivity(this, CommonConstant.REQUEST_ACT_ONE, CommonConstant.FROM_PRODUCT_DETAIL, productDetail.getAttributeList(), -1, -1, id);
                    }
                } else {
                    startActivity(new Intent(this, LoginActivity.class));
                }
            ...
            case R.id.tv_product_buy:
                if (UserCenter.isLogin(this)) {
                    if (productDetail != null) {
                        NormsActivity.startNormsActivity(this, CommonConstant.REQUEST_ACT_TWO, CommonConstant.FROM_PRODUCT_DETAIL, productDetail.getAttributeList(), -1, -1, id);
                    }
                } else {
                    startActivity(new Intent(this, LoginActivity.class));
                }
