...
//        public static String URL_BASE_DOMAIN = "http://192.168.1.111:8080";
//		public static String URL_BASE_DOMAIN = "http://192.168.3.246:8081";

//        public static String URL_BASE_DOMAIN = "http://221.122.116.5:8083";

        // 正式环境域名
        public static String URL_BASE_DOMAIN = "http://api.fyznyw.com";
//        public static String URL_BASE_DOMAIN = "http://221.122.116.5:8083";

        public static String YOUXI_PAY=URL_BASE_DOMAIN+"/qcCreateOrder";
        //检查更新
        ...
        //支付
        public static String URL_YOUXI_PAY = URL_BASE_DOMAIN + "/qcWeixinPayWay";
        //支付
        ...
        //查询商品库存
        public static String URL_POST_SELECT_STOCKQUANTITY = URL_BASE_DOMAIN + "/selectStockQuantity";
