...
import cn.antke.bct.login.controller.BindPersonalInfoAcitvity;
...
import static cn.antke.bct.common.CommonConstant.FROM_ACT_TWO;
...
public class PersonInfoActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    @ViewInject(R.id.personinfo_real_information_ll)
    private LinearLayout realInformation;
    ...
    private void initView() {
        ...
        realInformation.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.personinfo_constellation_rl:
                ...
                break;
            case R.id.personinfo_real_information_ll:
