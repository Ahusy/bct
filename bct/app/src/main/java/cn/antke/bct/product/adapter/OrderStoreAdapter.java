...
public class OrderStoreAdapter extends BaseAdapterNew<StoreDetailEntity> {
	...
	protected void setViewData(View convertView, int position) {
		...
		if (storeDetailEntity != null) {
			...
			tvConfirmStoreSubtotal.setText(Html.fromHtml("商品小计：" +InputUtil.formatPrice(productIntegral+"", productPrice+"")));
			tvConfirmStoreSubintegral.setText(Html.fromHtml("运费:<font color=\"#FF0000\">" + InputUtil.formatLogistics(logisticsIntegral, logisticsPrice) + "</font>"));
